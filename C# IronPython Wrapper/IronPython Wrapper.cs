...
namespace App1
{
    internal class Program
    {
        ...
        {
            IronP.DMM DMMCONTROL = new DMM();
            var read1 =  DMMCONTROL.time_read_current(20);
...
namespace IronP
{
    public class DMM{
        ...
        public double one_read_voltage() {
...
", scope);
        ...
        public double one_read_current()
        {
            var eng = IronPython.Hosting.Python.CreateEngine();
            var scope = eng.CreateScope();
            eng.Execute(@"
...
", scope);
        ...
        public double multiple_read_voltage(int NrOfTRR)
        {
            var eng = IronPython.Hosting.Python.CreateEngine();
            var scope = eng.CreateScope();
...
", scope);
        ...
        public double multiple_read_current(int NrOfTRR)
        {
            var eng = IronPython.Hosting.Python.CreateEngine();
            var scope = eng.CreateScope();
            scope.SetVariable("NrOfTriess", NrOfTRR);
...
", scope);
        ...
        public double time_read_voltage(int TimeS)
        {
            var eng = IronPython.Hosting.Python.CreateEngine();
            var scope = eng.CreateScope();
...
", scope);
        ...
        public double time_read_current(int TimeS)
        {
            var eng = IronPython.Hosting.Python.CreateEngine();
            var scope = eng.CreateScope();
            scope.SetVariable("timesec", TimeS);
